  ...
  return (
    <>
      ...
      {menuOpen && (
             ...
             <ul className="flex px-5 font-sans w-full z-30 flex-col gap-8 bg-daraz-primary  top-15 fixed  text-white py-10 text-2xl pb-20  cursor-pointer md:text-lg  font-bold">
