  ...
  return (
    <>
      <div className=" w-full relative  ">
        <img
          className="md:h-115 h-100 w-full  object-cover "
          src="https://images.pexels.com/photos/5632402/pexels-photo-5632402.jpeg"
          alt=""
        />
        <div className="absolute inset-0 bg-black/40 z-10 "></div>
        <div className="absolute w-90 mx-auto md:w-200 inset-0 flex flex-col items-center gap-8 md:px-15 px-5  text-white   font-semibold font-mono top-20  md:top-30 z-20">
